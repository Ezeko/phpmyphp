<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if($_POST['password'] == $_POST['confirmPassword']){
			...
			$file = $mysqli->real_escape_string('files/'.$_FILES['entry']['name']);
			...
			if (copy($_FILES['file']['tmp_name'], $file)){ 
				...
				$sql = "INSERT INTO user_info (fullname, username, file, password)" . "VALUES ('$fullname', '$username', '$file', '$password',)"; 
